...
@Slf4j
@Component("synchroPlanDvfTasklet")
@AllArgsConstructor
public class SynchroPlanDvfTasklet implements Tasklet{
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        jdbcTemplate.update("""
                ...
                ADD CONSTRAINT address_sync_plan_pkey
                PRIMARY KEY (id, old_hash, new_hash);
                """);
